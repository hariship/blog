...
const CoffeeLink = ({ text = 'Buy me a coffee', inline = true }: CoffeeLinkProps) => {
                ...
                <div className="coffee-qr-container">
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      const fallback = document.getElementById('coffee-fallback-link')
                      if (fallback) fallback.style.display = 'block'
                    }}
                  />
                  <div id="coffee-fallback-link" className="coffee-fallback">
